...
class EasyQACLI:
    ...
    def _setup_commands(self):
        ...
        visual_parser = subparsers.add_parser(
            'visual',
            help='Visual regression testing'
        )
        visual_parser.add_argument(
            'action',
            choices=['baseline', 'compare'],
            help='Visual testing action'
        )
        visual_parser.add_argument(
            '--screenshot',
            type=str,
        ...
        visual_parser.add_argument(
            '--baseline',
            type=str,
            help='Baseline image path (for compare)'
        )

        # Analytics
        analytics_parser = subparsers.add_parser(
            'analytics',
            help='View test analytics and insights'
        )
        analytics_parser.add_argument(
            'action',
            choices=['insights', 'predict', 'stats'],
        ...
        subparsers.add_parser(
            'healing-stats',
            help='View self-healing locator statistics'
        )
        ...
        config_parser.add_argument(
            '--key',
            type=str,
            help='Config key (dot notation: browser.default)'
        )
        config_parser.add_argument(
            '--value',
            type=str,
    ...
    def visual_testing(self, args):
        ...
        if args.action == 'baseline':
            baseline_path = tester.capture_baseline(
                args.screenshot,
                args.test_name
            )
